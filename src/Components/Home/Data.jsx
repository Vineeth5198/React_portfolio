  ...
  return (
    <div className="home_data">
      ...
      <p className="home_description">
        Hello, I'm Vineeth Molathoti, a dedicated and skilled
        <b> Software Engineer </b>
        specializing in front-end development with over
        <strong> 5 years </strong>
        of experience in the tech industry. I hold a
        <strong> Master's degree</strong> in <strong>Computer Science </strong>
        from the University of Central Missouri, and my passion lies in creating
        intuitive, high-performance responsive web applications that offer
        exceptional user experiences. I have a strong foundation in both
