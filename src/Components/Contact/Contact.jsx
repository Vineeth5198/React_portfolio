...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_1j3ax01", "template_d47vk7a", form.current, {
        publicKey: "UndWkiXrEE8nzhD1k",
      })
      .then(
        () => console.log("SUCCESS!"),
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">
                vineeth.molathoti@gmail.com
              </span>
              <a
                href="mailto:vineeth.molathoti@gmail.com?subject=Hello%20connecting%20from%20website"
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">
                linkedin.com/in/vineeth-molathoti
              </span>
              <a
                href="https://www.linkedin.com/in/vineeth-molathoti"
                className="contact_button"
                target="_blank"
            ...
            {/* <div className="contact_card">
              ...
              <span className="contact_card-data">user_id</span>
